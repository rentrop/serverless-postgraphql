...
class CrossingListHeader extends Component {
  ...
  render() {
    ...
    return (
      <div className="CrossingListHeader-background">
            ...
            <div className={classnames(params, 'CrossingListHeader')}>
              ...
              {params.smallsize ? (
                <div className="smallflex">
                  <div
                    className={classnames(params, 'CrossingListSortToggle')}
                    onClick={toggleSortByUpdated}
                  >
                    <div
                      className={classnames(
                        params,
                        'CrossingListSortToggleText',
                      )}
                    >
                      LAST UPDATED{' '}
                      {sortByUpdatedAsc ? (
                  ...
                  <div
                    className={classnames(params, 'CrossingListFilterToggle', {
                      selected: this.state.showFilterDrawer,
                    })}
                ...
                >
                  <div
                    className={classnames(params, 'CrossingListSortToggleText')}
                  >
                    LAST UPDATED{' '}
                    {sortByUpdatedAsc ? (
                      <FontAwesome name="caret-up" ariaLabel="Ascending" />
