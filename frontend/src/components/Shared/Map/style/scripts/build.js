...
fs.writeFileSync('src/components/Shared/Map/mapboxstyle.json', JSON.stringify(style, null, 2), 'utf8');
...
fs.writeFileSync('src/components/Shared/Map/mapboxstyle-undecorated.json', JSON.stringify(style, null, 2), 'utf8');
